...
//Get all books
publicUser.get("/", (req, res) => {
    res.status(200).json(books);
});

// Get book by ISBN
publicUser.get("/isbn/:isbn", (req, res) => {
...
// Get book by author
publicUser.get("/author/:author", (req, res) => {
...
// Get book by title
publicUser.get("/title/:title", (req, res) => {
...
publicUser.get("/review/:isbn", (req, res) => {
    const isbn = req.params.isbn;
    const book = books[isbn];
